...
class UserAnalyticsService {
  ...
  public async getUserActivities(userId: string, limit: number = 50): Promise<UserActivity[]> {
    try {
  ...
  public async getUserGameSessions(userId: string, limit: number = 20): Promise<GameSession[]> {
    try {

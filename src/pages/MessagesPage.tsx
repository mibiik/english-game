...
import { collection, query, where, getDocs, orderBy, doc, setDoc, getDoc, updateDoc, onSnapshot, Timestamp, deleteDoc } from 'firebase/firestore';
          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-500 text-sm">Keşfet sayfasından yeni arkadaşlar bulun</p>
                <button

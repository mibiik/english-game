  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#111] to-black text-gray-100 overflow-x-hidden">
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Yaklaşan Oyunlar</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                title: "Listening Challenge",
                description: "Dinleme becerilerinizi test edin. Kısa ses kayıtları dinleyerek soruları cevaplayın.",
              ...
              },
              {
                ...
                description: "İngilizce dilbilgisi kurallarını pekiştiren interaktif alıştırmalar.",
              ...
              },
              {
                ...
                description: "Yapay zeka destekli telaffuz eğitimi ile konuşma becerilerinizi geliştirin.",
              ...
              {
                title: "Story Builder",
                description: "Verilen kelimelerle yaratıcı hikayeler oluşturun ve yazma becerilerinizi geliştirin.",
              ...
              },
              {
                ...
                description: "Diğer öğrencilerle gerçek zamanlı yarışmalara katılın.",
                status: "Konsept Aşamasında",
              ...
              },
              {
                ...
                description: "Yapay zeka ile İngilizce konuşma pratiği yapın ve anlık geri bildirim alın.",
                status: "Araştırma Aşamasında",
              ...
              <motion.div
                key={index}
                className={`bg-gradient-to-br ${game.color} p-6 rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 shadow-lg hover:shadow-xl`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-white/80 text-sm mb-4 leading-relaxed">{game.description}</p>
                <div className="flex justify-between items-center">
                  <span className="text-white/60 text-xs">Tahmini: {game.eta}</span>

  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative h-48 bg-gradient-to-r from-gray-700 to-gray-800">
          ...
          <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2">
            <div className="relative w-32 h-32">
              <div className="absolute inset-0 bg-gradient-to-r from-gray-600 to-gray-700 rounded-full opacity-20 animate-pulse"></div>
              <div className="relative w-full h-full bg-gray-700 dark:bg-gray-800 rounded-full flex items-center justify-center border-4 border-gray-800 dark:border-gray-700">
        ...
        {/* Profile Content */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-10 pt-24 mt-16">
          ...
          <div className="relative mt-10 mb-8">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <span className="font-medium text-xl text-gray-900 dark:text-gray-100">Toplam Puan</span>
              </div>
              <span className="text-4xl font-bold text-gray-900 dark:text-gray-100">{totalScore}</span>
            </div>
            <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">Tüm oyunlardaki toplam başarınız</p>
          </div>
          {/* Game Scores */}
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Oyun Skorları</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {Object.entries(scores).map(([mode, score]) => (
              ...
              >
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-lg bg-white dark:bg-gray-800 flex items-center justify-center mr-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="font-bold text-gray-900 dark:text-gray-100 text-lg">{score}</span>
                </div>
              </div>
            ))}
          </div>
